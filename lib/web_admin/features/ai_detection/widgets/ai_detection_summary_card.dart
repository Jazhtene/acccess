...
class AiDetectionSummaryCard extends StatefulWidget {
  const AiDetectionSummaryCard({
    super.key,
    required this.label,
    required this.value,
    required this.icon,
  ...
  @override
  State<AiDetectionSummaryCard> createState() => _AiDetectionSummaryCardState();
}

class _AiDetectionSummaryCardState extends State<AiDetectionSummaryCard> {
  bool _hovered = false;
